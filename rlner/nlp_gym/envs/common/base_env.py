...
from rlner.nlp_gym.envs.common.observation import BaseObservation, BaseObservationFeaturizer
...
class BaseEnv(gym.Env):
    ...
    def __init__(
        ...
        Args:
            ...
            reward_function (RewardFunction): reward function that computes scalar reward for
                each observation-action
            observation_featurizer (ObservationFeaturizer): a featurizer that vectorizes input
                and context of observation
